...
public class TokenProvider {
    ...
    private static final Long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24 * 365L * 5; // 5년
    private static final Long REFRESH_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24 * 365L * 10;  // 10년
